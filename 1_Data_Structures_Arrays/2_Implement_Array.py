class MyArray():
    def __init__(self) -> None:
        self.lenght = 0 #We initialize the array's length to be zero
    ...
    def push(self, item):
        self.lenght += 1
        self.data[self.lenght - 1] = item #Adds the item provided to the end of the array

    def pop(self):
        last_item = self.data[self.lenght - 1] #Collects the last element
        del self.data[self.lenght - 1] #Deletes the last element from the array
        self.lenght -= 1#Decrements the length attribute of the array by 1
    ...
    def delete(self, index):
        ...
        del self.data[self.lenght - 1] #The last element which remains two times in the array is deleted
        self.lenght -= 1 #The lenght is decremented by 1. O(n) operation
