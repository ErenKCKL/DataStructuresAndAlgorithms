...
strings = ['a', 'b', 'c', 'd'] #4*4 = 16 bytes
array = [3, 5, 76, 76,7,67 6,45,6]
strings[2] #This will return the first element of the array, in this case, 'a', in O(1) time
...
strings.pop() #Pops/removes the element at the end of the array in O(1) time.   
#Insert
